...
router.get(
  "/enjoy-page/:level/:page",
  checkAuth,
  enjoy_controller.getEnjoyPage
);
router.get(
  "/enjoy-my-page/:level/:page",
  checkAuth,
  enjoy_controller.getEnjoyMyPage
);
//admin enjoy
router.get(
  "/enjoy-admin/:level",
  ...
  checkAdmin,
  checkSuperAdmin,
  enjoy_controller.getEnjoyAdmin
);
router.post(
  "/enjoy-admin",
  checkAuth,
  checkAdmin,
  checkSuperAdmin,
  enjoy_controller.postEnjoyAdmin
);
router.post(
  "/enjoy-admin-auto",
  checkAuth,
  checkAdmin,
  checkSuperAdmin,
  enjoy_controller.postEnjoyAdminAuto
);
//complaints
router.get(
  "/complaints/:status/:page",
  checkAuth,
  complaints_controller.getComplaints
);
...
router.get(
  "/complaints-admin/:status/:page",
  checkAuth,
  checkAdmin,
  complaints_controller.getComplaintsAdmin
);
router.post(
  "/complaints-admin",
  checkAuth,
  checkAdmin,
  complaints_controller.postComplaintsAdmin
);
router.get(
  "/new-complaints",
  checkAuth,
  complaints_controller.getNewComplaints
);
router.get(
  "/new-complaints-admin",
  checkAuth,
  checkAdmin,
  complaints_controller.getNewComplaintsAdmin
);
...
router.get(
  "/withdrawlList/:page/:status?",
  checkAuth,
  bank_controller.getWithdrawlList
);
router.get(
  "/withdrawl-admin/:status/:page",
  checkAuth,
  checkAdmin,
  bank_controller.getAdminWithdrawl
);
router.post(
  "/withdrawl-admin",
  checkAuth,
  checkAdmin,
  checkSuperAdmin,
  bank_controller.postAdminWithdrawl
);
router.get(
  "/recharge-admin/:page",
  checkAuth,
  checkAdmin,
  bank_controller.getAdminRecharge
);
router.post(
  "/recharge-admin",
  checkAuth,
  checkAdmin,
  checkSuperAdmin,
  bank_controller.postAdminRecharge
);
router.post("/recharge", checkAuth, bank_controller.postRecharge);
router.get(
  "/rechargeList/:page/:status?",
  checkAuth,
  bank_controller.getRechargeList
);
...
router.get(
  ...
  checkAuth,
  checkAdmin,
  reward_controller.listReward
);
router.delete(
  "/reward/:id",
  checkAuth,
  checkAdmin,
  reward_controller.deleteReward
);
...
router.get(
  ...
  checkAdmin,
  checkSuperAdmin,
  admin_controller.getTotal
);
router.get(
  "/admin/revenues1/:from/:to",
  checkAuth,
  checkAdmin,
  checkSuperAdmin,
  admin_controller.getRevenue1
);

router.get(
  "/admin/revenues/:from/:to",
  checkAuth,
  checkAdmin,
  checkSuperAdmin,
  admin_controller.getRevenue
);
router.get(
  "/admin/visits/:from/:to",
  checkAuth,
  checkAdmin,
  checkSuperAdmin,
  admin_controller.getVisit
);
router.get(
  "/admin/rws/:from/:to",
  checkAuth,
...
router.post(
  ...
  checkAdmin,
  checkSuperAdmin,
  envelopes_controller.createEnvelope
);
router.get(
  "/envelopes-admin/:page",
  checkAuth,
  checkAdmin,
  checkSuperAdmin,
  envelopes_controller.listEnvelopes
);
router.delete(
  "/envelopes-admin/:id",
  checkAuth,
  checkAdmin,
  checkSuperAdmin,
  envelopes_controller.deleteEnvelope
);
router.get("/red-envelope/:id", checkAuth, envelopes_controller.getEnvelope);
router.get(
  "/red-envelope-existed/:id",
  checkAuth,
  envelopes_controller.getEnvelopeExisted
);
