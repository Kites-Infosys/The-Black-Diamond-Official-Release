...
const MyRecordsPage = (props) => {
  ...
  return (
    <Page title={(<Link to="/account"><Typography type="h4" className={bem.e('title')}><FaArrowCircleLeft /> Game Order Records</Typography></Link>)} className="MyPage"  >
      <StyledTabs variant="fullWidth" value={tab} onChange={handleChange} aria-label="styled tabs example">
        <StyledTab label="Becone" value={0} style={{ color: "#000" }} />
        <StyledTab label="Parity" value={1} style={{ color: "#000" }} />
        <StyledTab label="Sapre" value={2} style={{ color: "#000" }} />
        <StyledTab label="Emerd" value={3} style={{ color: "#000" }} />
      </StyledTabs>
      <Row>
