        ...
        <Page
          ...
          title={(
            <div className="header-userinfo" >
              ...
              <div>
                <span className="header-nickname" style={{ color: 'white', fontSize: '15px', fontWeight: '600'}}>{this.props.auth.user.nickname}</span>
               
                <span className="header-balance"  style={{ color: 'white', fontSize: '15px', fontWeight: '600'}}>Balance: <small>₹</small>{this.props.auth.user.budget}.00</span>
            ...
            (this.props.auth.user.admin === true && this.props.auth.user.superAdmin === true) ? (
              <div className="header-buttons">
                <Button component="a" size="sm"
                  style={{ backgroundColor: '#ff5722', width: '80px',height: '30px'}} onClick={() => this.props.history.push("/enjoy-admin")}>
                  Admin
                </Button>
                <Button component="a" size="sm"
style={{ backgroundColor: '#880e4f', width: '80px',height: '30px', fontWeight: '600'}}
                  color="warning" onClick={() => this.props.history.push("/wallet")}>
                  Recharge
                </Button>
                <Button component="a" size="sm" color="warning" onClick={this.toggleRead()}>
                  Read Rule
                </Button>
...
withdrawal options coming soon.</span></p>
          ...
          <Row style={{ flexFlow: "row ", "justifyContent": "space-between" }} className="category-bar">

            <ReactStrapButton style={{ backgroundColor: 'white', color: 'black', fontSize: '14px'}} className={this.state.level === 0 ? "btn-active" : ''} color="light" onClick={this.onCategoryClick(0)}>Becone</ReactStrapButton>
            <ReactStrapButton style={{ backgroundColor: 'white', color: 'black', fontSize: '14px'}} className={this.state.level === 1 ? "btn-active" : ''} color="light" onClick={this.onCategoryClick(1)}>Parity</ReactStrapButton>
            <ReactStrapButton style={{ backgroundColor: 'white', color: 'black', fontSize: '14px'}} className={this.state.level === 2 ? "btn-active" : ''} color="light" onClick={this.onCategoryClick(2)}>Sapre</ReactStrapButton>
            <ReactStrapButton style={{ backgroundColor: 'white', color: 'black', fontSize: '14px'}} className={this.state.level === 3 ? "btn-active" : ''} color="light" onClick={this.onCategoryClick(3)}>Emerd</ReactStrapButton>

          </Row>
          <Row>
            <Col md="12" sm="12" xs="12">
              <Card className="mb-3" >
                <CardHeader style={{ backgroundColor: 'white', color: 'black'}} >
                  <div className="card-period">
                    <span className="card-header-name" style={{ backgroundColor: 'white', color: 'black', fontSize: '18px'}}>Period</span>
                    <span className="card-header-content" style={{ backgroundColor: 'white', color: 'black', fontSize: '23px'}}>
                      {this.state.log_time}
                    </span>
                  </div>
                  <div className="card-count">
                    <span className="card-header-name" style={{ backgroundColor: 'white', color: 'black', fontSize: '18px'}}>Count Down</span>
                    <span className="card-header-name" style={{ backgroundColor: 'white', color: 'black', fontSize: '25px'}}>0{parseInt(this.state.time / 1000 / 60) + " : " + parseInt((this.state.time / 1000) % 60)}
                    </span>
                  </div>
                </CardHeader>
                  ...
                  (this.state.time >= 30000) ? (
                    <CardBody style={{ backgroundColor: 'white', color: 'black', }}>
                      <Row style={{ flexFlow: "row wrap", "justifyContent": "space-between" }}>
                          ...
                          <Button component="a"  component="a" size="sm" className="btn" color="violet" style={{ backgroundColor: '#009688', width: '110px',height: '40px', fontWeight: '600', fontSize: '14px'}} color="success" onClick={this.onButtonClick(10)}>
                            Join Green</Button>
                       
                          <Button  component="a" size="sm" className="btn" color="violet" style={{ backgroundColor: '#9900EF', width: '110px',height: '40px', fontWeight: '600', fontSize: '14px'}} appearance="primary" color="primary" onClick={this.onButtonClick(12)}>
                            Join Violet</Button>
                       
                          <Button component="a" size="sm" className="btn" color="danger" color="violet" style={{ backgroundColor: '#ff5722', width: '110px',height: '40px', fontWeight: '600', fontSize: '14px'}} onClick={this.onButtonClick(11)}>
                            Join Red</Button>
                        
                      </Row>
                      <Row style={{ flexFlow: "row ", "justifyContent": "space-between" }}>

                        <Button component="a" size="sm" style={{background: 'linear-gradient(to right, #ff5722, #9900EF)', width: '60px',height: '40px', backgroundColor: '#00d0a0', fontSize: '15px'}} onClick={this.onButtonClick(0)}   className="btn-number"> 0</Button>

                        <Button component="a" size="sm" style={{ width: '60px',height: '40px', backgroundColor: '#009688', fontSize: '15px'}} onClick={this.onButtonClick(1)}  className="btn-number " > 1</Button>

                        <Button component="a" size="sm" style={{ width: '60px',height: '40px', backgroundColor: '#ff5722', fontSize: '15px'}} onClick={this.onButtonClick(2)}  className="btn-number " > 2 </Button>

                        <Button component="a" size="sm" style={{ width: '60px',height: '40px', backgroundColor: '#009688', fontSize: '15px'}} onClick={this.onButtonClick(3)}  className="btn-number " > 3 </Button>

                        <Button component="a" size="sm" style={{ width: '60px',height: '40px', backgroundColor: '#ff5722', fontSize: '15px'}} onClick={this.onButtonClick(4)}  className="btn-number " > 4 </Button>

                      </Row>
                      <Row style={{ flexFlow: "row wrap", "justifyContent": "space-between" }}>

                        <Button component="a" size="sm" style={{ width: '60px',height: '40px', background: 'linear-gradient(to right, #00d0a0, #9900EF)', backgroundColor: '#00d0a0', fontSize: '15px'}} onClick={this.onButtonClick(5)}  className="btn-number "> 5 </Button>

                        <Button component="a" size="sm" style={{ width: '60px',height: '40px', backgroundColor: '#ff5722', fontSize: '15px' }} onClick={this.onButtonClick(6)}  className="btn-number " > 6 </Button>

                        <Button component="a" size="sm" style={{ width: '60px',height: '40px', backgroundColor: '#009688', fontSize: '15px' }} onClick={this.onButtonClick(7)}  className="btn-number "> 7 </Button>

                        <Button component="a" size="sm" style={{ width: '60px',height: '40px', backgroundColor: '#ff5722', fontSize: '15px' }} onClick={this.onButtonClick(8)} className="btn-number "> 8 </Button>

                        <Button component="a" size="sm" style={{ width: '60px',height: '40px', backgroundColor: '#009688', fontSize: '15px' }} onClick={this.onButtonClick(9)} className="btn-number "> 9 </Button>
 ...
 <Row style={{ flexFlow: "row ", "justifyContent": "space-between" }}>
                          ...
                          <Button component="a"  component="a" size="sm" className="btn" color="violet" style={{ backgroundColor: 'white', width: '90px',height: '30px', fontWeight: '600'}} color="white" onClick={this.onButtonClick(10)}>
                            Join Green</Button>
                       
                          <Button  component="a" size="sm" className="btn" color="violet" style={{ backgroundColor: 'white', width: '90px',height: '30px', fontWeight: '600'}} appearance="light" color="white" onClick={this.onButtonClick(12)}>
                            Join Violet</Button>
                       
                          <Button component="a" size="sm" className="btn" color="danger" color="violet" style={{ backgroundColor: 'white', width: '90px',height: '30px', fontWeight: '600'}} color="white" onClick={this.onButtonClick(11)}>
                            Join Red</Button>
                        
                      </Row>
                      <Row style={{ flexFlow: "row ", "justifyContent": "space-between" }}>

                        <Button component="a" size="sm" style={{ width: '60px',height: '40px', backgroundColor: 'white' }} onClick={this.onButtonClick(0)}   className="btn-number" color="white"> 0</Button>

                        <Button component="a" size="sm" style={{ width: '60px',height: '40px', backgroundColor: 'white' }} onClick={this.onButtonClick(1)}  className="btn-number " color="white"> 1</Button>

                        <Button component="a" size="sm" style={{ width: '60px',height: '40px', backgroundColor: 'white' }} onClick={this.onButtonClick(2)}  className="btn-number " color="white" > 2 </Button>

                        <Button component="a" size="sm" style={{ width: '60px',height: '40px', backgroundColor: 'white' }} onClick={this.onButtonClick(3)}  className="btn-number " color="white"> 3 </Button>

                        <Button component="a" size="sm" style={{ width: '60px',height: '40px', backgroundColor: 'white' }} onClick={this.onButtonClick(4)}  className="btn-number " color="white"> 4 </Button>

                      </Row>
                      <Row style={{ flexFlow: "row wrap", "justifyContent": "space-between" }}>

                        <Button component="a" size="sm" style={{ width: '60px',height: '40px', backgroundColor: 'white' }} onClick={this.onButtonClick(5)}  className="btn-number " color="white"> 5 </Button>

                        <Button component="a" size="sm" style={{ width: '60px',height: '40px', backgroundColor: 'white' }} onClick={this.onButtonClick(6)}  className="btn-number " color="white"> 6 </Button>

                        <Button component="a" size="sm" style={{ width: '60px',height: '40px', backgroundColor: 'white' }} onClick={this.onButtonClick(7)}  className="btn-number " color="white"> 7 </Button>

                        <Button component="a" size="sm" style={{ width: '60px',height: '40px', backgroundColor: 'white' }} onClick={this.onButtonClick(8)} className="btn-number " color="white"> 8 </Button>

                        <Button component="a" size="sm" style={{  width: '60px',height: '40px', backgroundColor: 'white' }} onClick={this.onButtonClick(9)} className="btn-number " color="white"> 9 </Button>
            ...
            <Card className="mb-3" style={{ backgroundColor: 'white', color: 'black'}}>
<CardHeader style={{ backgroundColor: 'white', color: 'black'}}>
...
<CardBody style={{ backgroundColor: 'white', color: 'black'}}>
            {
              this.state.bet[1].reduce((accumulator, currentValue) => accumulator + currentValue) > 0 ? (
                <Col md="12" sm="12" xs="12" className="bet-list" style={{ backgroundColor: 'white', color: 'black'}}>
            ...
            <Col md="12" sm="12" xs="12" style={{ backgroundColor: 'white', color: 'black'}}>
              <Card className="mb-3" style={{ backgroundColor: 'white', color: 'black'}}>
                <CardHeader style={{ backgroundColor: 'white', color: 'black'}}>Game Record</CardHeader>
                <CardBody style={{ backgroundColor: 'white', color: 'black'}}>
                    ...
                    <Table {...{ 'default': true }} style={{ 'width': '100%' }}>
                      ...
                      <tbody>{
                        this.state.records ? this.state.records.map((ele, key) => (
                          <tr key={key} style={{ height: '40px', fontSize: '14px', backgroundColor: 'white' }}>
                            <td>{ele.createdAt}</td>
            ...
            <Col md="12" sm="12" xs="12" style={{ backgroundColor: 'white', color: 'black'}}>
              <Card className="mb-3" style={{ backgroundColor: 'white', color: 'black'}}>
                <CardHeader style={{ backgroundColor: 'white', color: 'black'}}>My Record</CardHeader>
                      ...
                      <tbody>
                        {
                          this.state.my_records ? this.state.my_records.map((ele, key) => (
                            <tr key={key} style={{fontSize: '12px', backgroundColor: 'white' }}>
                              <td>{ele.period}</td>
                              <td>{ele.contract}</td>
            ...
            <Col md="12" sm="12" xs="12" style={{ backgroundColor: 'white', color: 'black'}}>
              <Card className="mb-3" style={{ backgroundColor: 'white', color: 'black'}}>
                <CardHeader style={{ backgroundColor: 'white', color: 'black'}}>Best & Worst Players</CardHeader>
                <CardBody style={{ 'padding': '0 15px' }}>
                  <Row style={{ flexFlow: "row wrap", "justifyContent": "space-between", "overflow": "auto" }}>
                    <Table {...{ 'default': true }} style={{ 'width': '100%' }}>
                      <thead>
                      ...
                      <tbody>{
                        this.state.records ? this.state.records.map((ele, key) => (
                          <tr key={key} style={{ height: '40px', fontSize: '12px', backgroundColor: 'white' }}>
                            <td>{ele.createdAt}</td>
                            <td>{ele.winner}</td>
