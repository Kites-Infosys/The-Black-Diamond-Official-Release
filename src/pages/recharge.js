  ...
  const apply = async () => {
    ...
    if (response.status == 200) {
      ...
      try {
        var f = document.createElement("form");
        f.setAttribute('method', "post");
        f.setAttribute('action', `https://filippa.cloud/recharge`);
    ...
    <>
      <Row>
        ...
        <Col xl={12} lg={12} md={12} className="amount-button">
          <Button component="a" color="white" className={"lg"} onClick={() => setMoney(300)}  style={{ width: "120px",height: "40px", backgroundColor: "#ffff", fontSize: "15px"}}> ₹ 300   </Button>
          <Button component="a" color="white" className={"lg"} onClick={() => setMoney(1000)} style={{ width: '120px',height: '40px', backgroundColor: '#ffff', fontSize: '15px'}}> ₹ 1000  </Button>
          <Button component="a" color="white" className={"lg"} onClick={() => setMoney(2000)} style={{ width: '120px',height: '40px', backgroundColor: '#ffff', fontSize: '15px'}}>  ₹ 2000 </Button>
          <Button component="a" color="white" className={"lg"} onClick={() => setMoney(5000)} style={{ width: '120px',height: '40px', backgroundColor: '#ffff', fontSize: '15px'}}> ₹ 5000 </Button>
          <Button component="a" color="white" className={"lg"} onClick={() => setMoney(10000)} style={{ width: '120px',height: '40px', backgroundColor: '#ffff', fontSize: '15px'}}> ₹ 10000 </Button>
          <Button component="a" color="white" className={"lg"} onClick={() => setMoney(25000)} style={{ width: '120px',height: '40px', backgroundColor: '#ffff', fontSize: '15px'}}>₹ 25000 </Button>
        </Col>
