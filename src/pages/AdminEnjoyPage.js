      ...
      return (
        <Page
          ...
          breadcrumbs={
             (
              <div style={{'width':'100%'}}>
              <Button color="reddit" onClick={this.onAutoMax} style={{"float":"left", backgroundColor: '#f60c28', color: '#fff'}}  >{this.state.auto ? 'Manual' : 'Auto'}</Button>
              <Button color="reddit" onClick={this.onReload} style={{"float":"right", backgroundColor: '#fad0c3', color: '#0f0501'}}><FaSyncAlt /></Button>
              </div>
              )        
            }
        >
          <Row>
            <Col md="12" sm="12" xs="12">
              ...
              <Button className={this.state.level===0 && "btn-active"} color="link" onClick={this.onCategoryClick(0)}>Becone</Button>
