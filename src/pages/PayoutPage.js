...
const PayoutPage = (props) => {
  ...
  return (
    <>
      ...
      <Row>
      <Col xl={12} lg={12} md={12}  style={{ fontSize: '0.5rem', color: 'red' }}>
        (Note: Withdrawal Time: 10:00 AM TO 6:00 PM
        MONDAY TO SATERDAY)
        </Col>
        ...
        <Col md={12} style={{ textAlign: 'center' }} className={'mt-3'}>
          <Button onClick={apply} size="sm" color="warning" block> Withdraw </Button>
        </Col>
