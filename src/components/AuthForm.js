...
import { Form, FormGroup, Input, Label, InputGroup, InputGroupAddon, InputGroupText  } from 'reactstrap';
import {
...
class AuthForm extends React.Component {
  ...
  render() {
    ...
    <InputGroupAddon addonType="prepend" style={{height: "38px"}}>
        <InputGroupText style={{height: "38px"}}>
          <CircumIcon name="mobile_4" style={{height: "38px"}} />
        </InputGroupText>
    </InputGroupAddon>
 <Input {...usernameInputProps} onChange={this.changePhone} value={this.state.phone} /></InputGroup>
    ...
    <InputGroupAddon addonType="prepend" style={{height: "38px"}}>
        <InputGroupText style={{height: "38px"}}>
         <CircumIcon name="lock" style={{height: "38px"}} />
        </InputGroupText>
    </InputGroupAddon>
    ...
    <InputGroupAddon addonType="prepend" style={{height: "38px"}}>
        <InputGroupText style={{height: "38px"}}>
         <CircumIcon name="import" style={{height: "38px"}} />
        </InputGroupText>
    </InputGroupAddon>
 <Input type='text' {...recommendationCodeInputProps} value={this.state.recommendationCode} onChange={this.changeRecommendationCdoe} />                 
    ...
    <Input type='text' placeholder='Please type your phone number' value={this.state.phone} onChange={this.changePhone} />
                  ...
                  <>
                    <FormGroup>
                      <Button onClick={this.sendOTP} color="warning" >{this.otpProgress ? (<PageSpinner />) : 'Resend OTP'}</Button>
                    </FormGroup>
                    <FormGroup>
