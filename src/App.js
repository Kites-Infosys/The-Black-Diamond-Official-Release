...
const EkPayPage = React.lazy(() => import('pages/EkPayPage'));
const DepositPage = React.lazy(() => import('pages/DepositPage'));
const PayoutPage = React.lazy(() => import('pages/PayoutPage'));

const Mine = React.lazy(() => import('pages/mine'));
const blackdiamondapp = React.lazy(() => import ('pages/blackdiamondapp.apk'));
            ...
            <Switch>
              ...
              <MainLayout breakpoint={this.props.breakpoint}>
                <React.Suspense fallback={<PageSpinner />}>
                  ...
                  <PrivateRoute exact path="/withdrawal" component={WithdrawlPage} />
                  <PrivateRoute exact path="/recharge" component={RechargePage} />
                  <PrivateRoute exact path="/ekpay" component={EkPayPage} />
                  <PrivateRoute exact path="/deposit" component={DepositPage} />
                  <PrivateRoute exact path="/payout" component={PayoutPage} />
                  <PrivateRoute exact path="/blackdiamondapp" component={blackdiamondapp} />
                  ...
                  <PrivateRoute exact path="/aboutUS" component={AboutUSPage} />
                  <PrivateRoute exact path="/my/policy" component={PolicyPage} />
